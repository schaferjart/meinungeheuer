...
export const COLD_START = {
    ...
    firstMessageDe: 'Jemand war gerade hier vor dir. Sie haben etwas hinterlassen. Ich bin neugierig — was bringst du mit?',
    /** English opener when there's no icebreaker from a previous visitor. */
    firstMessageEn: 'Someone was just here before you. They left something behind. I am curious — what do you bring?',
};
// ============================================================
...
//# sourceMappingURL=voiceChainConfig.js.map