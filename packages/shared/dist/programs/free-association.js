 ...
 */
export const freeAssociationProgram = {
    id: 'free_association',
    name: 'Free Association',
    description: 'Open-ended conversation starting from whatever is on the visitor\'s mind. No text, no predefined term.',
    stages: {
        textReading: false,
        termPrompt: false,
        portrait: false,
...
//# sourceMappingURL=free-association.js.map