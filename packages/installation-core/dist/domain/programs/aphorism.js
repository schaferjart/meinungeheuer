import { addParagraphNumbers } from '../../primitives/textUtils.js';
 ...
 */
export const aphorismProgram = {
    id: 'aphorism',
    name: 'Aphorism',
    description: 'Visitor reads a text, AI discovers what resonates, conversation produces an aphorism printed on a card.',
    stages: {
        textReading: true,
        termPrompt: false,
        portrait: true,
...
//# sourceMappingURL=aphorism.js.map