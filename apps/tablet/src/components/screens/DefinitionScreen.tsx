...
// Archive URL for the QR code printed on each card. Set VITE_ARCHIVE_BASE in
// the tablet app's .env to point at your deployed archive app (see apps/archive).
// Leave empty to skip the QR code entirely.
const ARCHIVE_BASE = import.meta.env.VITE_ARCHIVE_BASE ?? '';
